...
spec_bench_specifiers = [
        ...
        ['perl', '400.perlbench', 'perlbench_base.gcc', '-I./lib checkspam.pl 2500 5 25 11 150 1 1 1 1'],
        ...
        ['sphinx', '482.sphinx3', 'sphinx_livepretend_base.gcc', 'ctlfile . args.an4'],
        ['xalanc', '483.xalancbmk', 'Xalan_base.gcc', '-v t5.xml xalanc.xsl'],
		]
